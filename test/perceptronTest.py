...
from validate.binaryClassifyValidate import BiClassifyValidater
...
if __name__ == '__main__':
    ...
    plt.plot([0, testX.T[0].max() + 1],
             [-1 * model.theta[2] / model.theta[1], -1 * model.theta[0] * (testX.T[0].max() + 1) / model.theta[1]], '-',
             lw=1)
    plt.show()
